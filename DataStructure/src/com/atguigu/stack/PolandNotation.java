...
public class PolandNotation {
    ...
    public static List<String> parseSuffixExpressionList(List<String> ls) {
        ...
        // 说明：因为s2这个栈，再在整个转换过程中，没有pop操作，而且后面我们还需要逆序输出
        // 因此比较麻烦，这里我们就不用Stack<String>直接使用List<String> s2
        // Stack<String> s2 = new Stack<String>(); // 储存中间结果的Lists2
        ...
        for (String item : ls) {
            ...
            if (item.matches("\\d+")) {
                ...
                // 当item的优先级小于等于s1栈顶运算符，将s1栈顶的运算符弹出并加入到s2中，再次转到(4.1)中与s1中新的栈顶运算符相比较
                // 问题：我们缺少一个比较优先级高低的方法
